...
ALTER TABLE `v2_server_trusttunnel` ADD COLUMN `upstream_protocol` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT 'http2 | http3, empty lets the client choose';
ALTER TABLE `v2_server_trusttunnel` ADD COLUMN `has_ipv6` tinyint(1) NOT NULL DEFAULT '0';
ALTER TABLE `v2_server_trusttunnel` ADD COLUMN `dns_upstreams` text COLLATE utf8mb4_unicode_ci COMMENT 'one per line, encrypted DNS through the tunnel';
