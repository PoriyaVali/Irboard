...
class ConfigSave extends FormRequest
{
    const RULES = [
        ...
        'frontend_login_path' => 'nullable|string',
        ...
        // Bot Settings
        'bot_enabled' => 'in:0,1',
        'payment_transit_enable' => 'in:0,1',
        'payment_transit_url' => 'nullable|url',
        'payment_proxy_enable' => 'in:0,1',
        'payment_proxy_url' => 'nullable|url',
        'payment_proxy_secret' => 'nullable|string',
        'test_duration' => 'nullable|integer',
        'test_limit' => 'nullable|integer',
        'test_volume' => 'nullable|integer',
        'usd_pricing_enabled' => 'in:0,1',
        // app
        'windows_version' => '',
