...
class AdminRoute
{
    public function map(Registrar $router)
    {
        $router->group([
            ...
            $router->get ('/card-payment/stats', 'V1\\Admin\\CardPaymentController@stats');
            // Server Traffic
            $router->get ('/server-traffic/top15', 'V1\\Admin\\ServerTrafficController@top15');
            $router->get ('/server-traffic/top-users', 'V1\\Admin\\ServerTrafficController@topUsers');
