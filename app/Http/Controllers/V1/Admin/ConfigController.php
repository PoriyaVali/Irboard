...
class ConfigController extends Controller
{
    ...
    public function fetch(Request $request)
    {
        ...
        $data = [
            ...
            'site' => [
                ...
                'frontend_url' => config('v2board.frontend_url'),
                'frontend_login_path' => config('v2board.frontend_login_path', 'index.html'),
            ...
            'telegram' => [
                ...
                // تنظیمات ربات تلگرام
                'bot_enabled' => BotSetting::get('bot_enabled', '0'),
                'payment_transit_enable' => BotSetting::get('payment_transit_enable', '0'),
                'payment_transit_url' => BotSetting::get('payment_transit_url', ''),
                'payment_proxy_enable' => BotSetting::get('payment_proxy_enable', '0'),
                'payment_proxy_url' => BotSetting::get('payment_proxy_url', ''),
                'payment_proxy_secret' => BotSetting::get('payment_proxy_secret', ''),
                'test_duration' => BotSetting::get('test_duration', '1'),
                'test_limit' => BotSetting::get('test_limit', '1'),
                'test_volume' => BotSetting::get('test_volume', '500'),
                'usd_pricing_enabled' => BotSetting::get('usd_pricing_enabled', '0'),
            ],
            'app' => [
    ...
    public function save(ConfigSave $request)
    {
        ...
        $botSettings = [
            'bot_enabled', 'payment_transit_enable', 'payment_transit_url',
            'payment_proxy_enable', 'payment_proxy_url', 'payment_proxy_secret',
            'test_duration', 'test_limit', 'test_volume', 'usd_pricing_enabled'
        ];
        foreach ($botSettings as $key) {
            if (array_key_exists($key, $data)) {
                BotSetting::set($key, $data[$key]);
                unset($data[$key]);
            }
        }
