...
class UniProxyController extends Controller
{
    ...
    // node status heartbeat (cpu/mem/uptime...) - V2bX posts this every 60s
        ...
        switch ($this->nodeType) {
            case 'mdns':
                $response = [
                    ...
                    'domain' => $this->nodeInfo->domain,
                    'encryption_method' => $this->nodeInfo->encryption_method,
                    'encryption_key' => $this->nodeInfo->encryption_key,
