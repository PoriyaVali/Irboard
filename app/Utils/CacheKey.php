...
class CacheKey
{
    CONST KEYS = [
        ...
        'SERVER_MDNS_LAST_CHECK_AT' => 'mdns node last check',
        'SERVER_MDNS_ONLINE_USER' => 'mdns node online users',
        'SERVER_MDNS_LAST_PUSH_AT' => 'mdns node last push',
        'SERVER_TRUSTTUNNEL_LAST_CHECK_AT' => 'trusttunnel node last check',
        'SERVER_TRUSTTUNNEL_ONLINE_USER' => 'trusttunnel node online users',
        'SERVER_TRUSTTUNNEL_LAST_PUSH_AT' => 'trusttunnel node last push',
